...
This version selects some entries by theme/topic for easier reference. **For the more frequently updated chronological version, see [README-chronological.md](https://github.com/Daniel-Gong/NeuroAI-Readings/blob/main/README-chronological.md)**.
