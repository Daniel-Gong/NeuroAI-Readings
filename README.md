...
[李老师不是你老师李老师不是你老师 – 精日展览馆](https://revealscum.com/291/07/28/)

[awhvogellab.com/files/pdfs/Thyer_et_al_2022.pdf](https://awhvogellab.com/files/pdfs/Thyer_et_al_2022.pdf)

[jneurosci.org/content/jneuro/45/18/e2347242025.full.pdf](https://www.jneurosci.org/content/jneuro/45/18/e2347242025.full.pdf)

[EEG processing workflow and ICA application - Support & Discussions - MNE Forum](https://mne.discourse.group/t/eeg-processing-workflow-and-ica-application/3073)

[Decoding (MVPA) — MNE 1.10.0 documentation](https://mne.tools/stable/auto_tutorials/machine-learning/50_decoding.html#sphx-glr-auto-tutorials-machine-learning-50-decoding-py)

[Motor imagery decoding from EEG data using the Common Spatial Pattern (CSP) — MNE 1.10.0 documentation](https://mne.tools/stable/auto_examples/decoding/decoding_csp_eeg.html)

[\[\]](https://natmeg.se/mne_multivariate/mne_multivariate.html)

[Linear classifier on sensor data with plot patterns and filters — MNE 1.10.0 documentation](https://mne.tools/stable/auto_examples/decoding/linear_model_patterns.html#footcite-haufeetal2014)

[Decoding source space data — MNE 1.10.0 documentation](https://mne.tools/stable/auto_examples/decoding/decoding_spatio_temporal_source.html#sphx-glr-auto-examples-decoding-decoding-spatio-temporal-source-py)

[Stimulus representation in human frontal cortex supports flexible control in working memory](https://elifesciences.org/reviewed-preprints/100287)

[The representation of abstract goals in working memory is supported by task-congruent neural geometry | PLOS Biology](https://journals.plos.org/plosbiology/article?id=10.1371/journal.pbio.3002461)

[Distinct neural signatures underlying information maintenance and manipulation in working memory | Cerebral Cortex | Oxford Academic](https://academic.oup.com/cercor/article/34/3/bhae063/7618463)

[宫栋宇 - Google Search](https://www.google.com/search?q=%E5%AE%AB%E6%A0%8B%E5%AE%87&rlz=1CDGOYI_enUS1106US1106&oq=%E5%AE%AB%E6%A0%8B%E5%AE%87&gs_lcrp=EgZjaHJvbWUqBggAEEUYOzIGCAAQRRg7MggIARBFGCcYOzIGCAIQRRg9MgYIAxBFGD0yCggEEAAYgAQYogQyCggFEAAYgAQYogQyCggGEAAYgAQYogQyCggHEAAYgAQYogQyBggIEEUYO9IBCDExMDdqMGo0qAITsAIB4gMEGAEgX_EF3iShJWpN_n8&hl=en-US&sourceid=chrome-mobile&ie=UTF-8)

[proceedings.mlr.press/v38/hensman15.pdf](https://proceedings.mlr.press/v38/hensman15.pdf)

[jmlr.org/papers/volume6/quinonero-candela05a/quinonero-candela05a.pdf](https://www.jmlr.org/papers/volume6/quinonero-candela05a/quinonero-candela05a.pdf)

[Gaussian Processes — PyMC 5.25.1 documentation](https://www.pymc.io/projects/docs/en/stable/learn/core_notebooks/Gaussian_Processes.html)

[\[2301.13195\] Adaptive Computation with Elastic Input Sequence](https://arxiv.org/abs/2301.13195)

[Adaptive Computation Time: Tailoring Neural Network Efficiency for Real-World Applications | by Everton Gomede, PhD | The Modern Scientist | Medium](https://medium.com/the-modern-scientist/adaptive-computation-time-tailoring-neural-network-efficiency-for-real-world-applications-f5c6f1cf93d5)

[\[1603.08983\] Adaptive Computation Time for Recurrent Neural Networks](https://arxiv.org/abs/1603.08983)

[Where Are the Fixed Points of Foundation Models?](https://substack.com/inbox/post/168770824?triedRedirect=true)

[arxiv.org/pdf/2009.10862v5](https://arxiv.org/pdf/2009.10862v5)

[Mathematical understanding of Gaussian Process | by Yuki Shizuya | The Quantastic Journal | Medium](https://medium.com/the-quantastic-journal/mathematical-understanding-of-gaussian-process-eaffc9c8a6d6)

[galton.uchicago.edu/~lalley/Courses/386/GaussianProcesses.pdf](https://galton.uchicago.edu/~lalley/Courses/386/GaussianProcesses.pdf)
...
[Zhu Jian-Qiao (@JQ_Zhu) / X](https://x.com/JQ_Zhu)

[Home](https://sites.google.com/view/zhujq)

[‪Jian-Qiao Zhu‬ - ‪Google Scholar‬](https://scholar.google.com/citations?user=J5n6WdwAAAAJ&hl=en&oi=ao)

[Keynote & Tutorial – Digital Brain Models for Working Memory](https://2025.ccneuro.org/k-and-t-digital-brain-models/)
...
[Mingfang Zhang - Google Search](https://www.google.com/search?q=Mingfang+Zhang&rlz=1C5CHFA_enGB1044GB1044&sourceid=chrome&ie=UTF-8)

[NeuroAI-Readings/README.md at main · Daniel-Gong/NeuroAI-Readings](https://github.com/Daniel-Gong/NeuroAI-Readings/blob/main/README.md)

[lucyzmf/NeuralDecoding-CCN2025: Repo for tutorial notebooks for the workshop Language: In search of a neural code at CCN2025](https://github.com/lucyzmf/NeuralDecoding-CCN2025/#)

[part1-linear_decoding.ipynb - Colab](https://colab.research.google.com/github/lucyzmf/NeuralDecoding-CCN2025/blob/main/part1-linear_decoding.ipynb#scrollTo=weIH_wc2pawD)

[part2-exca.ipynb - Colab](https://colab.research.google.com/github/lucyzmf/NeuralDecoding-CCN2025/blob/main/part2-exca.ipynb#scrollTo=xnOFaD-6LCHR)

[part3-deep_decoding.ipynb - Colab](https://colab.research.google.com/github/lucyzmf/NeuralDecoding-CCN2025/blob/main/part3-deep_decoding.ipynb)

[CCN_2025_Working_memory.ipynb - Colab](https://colab.research.google.com/drive/154eJgCdebkH7EoL2LFquoqELIs70Drn4?usp=sharing#scrollTo=ZeMHyZJrra0o)

[Copy of CCN_2025_Working_memory.ipynb - Colab](https://colab.research.google.com/drive/1K1yRGJ6Lr9WVu08SO9LrEpQ5wDHApc-9#scrollTo=pbxkfdTiVsdj)

[Emergence of distributed working memory in a human brain network model | bioRxiv](https://www.biorxiv.org/content/10.1101/2023.01.26.525779v1.full)

[Keynote Lecture: Ellie Pavlick](https://2025.ccneuro.org/keynote-ellie-pavlick/)

[‪Ellie Pavlick‬ - ‪Google Scholar‬](https://scholar.google.com/citations?hl=en&user=sFyrSa8AAAAJ&view_op=list_works&sortby=pubdate)
